...
int main()
{
	...
	histInfo data = {"Data", "condor/superbaseline_1/2016_BG_OTHER.root", "PEX0", kBlack, false};

	//vector summarizing background histograms to include in the plot
    	std::vector<histInfo> bgEntries = {
	
		{"T#bar{T}",        "condor/superbaseline_1/2016_TT.root",              "hist", kBlue - 7   },
        	{"DYJetsToLL_M-50", "condor/superbaseline_2/2016_DYJetsToLL_M-50_Incl.root", "hist", kOrange + 2 },
		...
		{"RPV m_{#tildet} = 500", "condor/superbaseline_1/2016_RPV_2t6j_mStop-500.root",        "hist", kOrange - 3}, 
		{"RPV m_{#tildet} = 300", "condor/superbaseline_1/2016_RPV_2t6j_mStop-300.root",        "hist", kGreen + 3 },
		{"RPV m_{#tildet} = 700", "condor/superbaseline_1/2016_StealthSYY_2t6j_mStop-700.root", "hist", kBlue + 1  },
